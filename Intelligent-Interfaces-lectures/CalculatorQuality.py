...
def membership_function(x, y):
    ...
    if y <= 50:
        ...
        if y <= 75:
            ...
            lecture_notes_dict['High'] = (y - 50) / 50
    print("Значення фунцій приналежності для лінгвістичної змінної \"Якість обслуговування\": {0}\n"
          "Значення фунцій приналежності для лінгвістичної змінної \"Якість страв\": {1}".format(attendance_dict,
                                                                                           lecture_notes_dict))
...
def build_membership_plots():
    ...
    ax_1.set(xlabel='Якість обслуговування',
             ylabel='Функція приналежності')
    ax_2.set(xlabel='Якість страв',
             ylabel='Функция приналежності')

    ax_1.set(title='Якість обслуговування')
    ax_2.set(title='Якість страв')
    ...
    ax_3.set(xlabel='Якість обслуговування',
             ylabel='Функція приналежності',
             title='Чайові')
